...
var teamData = [
    ...
    },
    {
        ...
        "teamIcon": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQPXgWhdj9yC_5AglXavYuTyTVr0zPpv0yhg&usqp=CAU",
        "WonCount": 4,
    },
    {
        "id": 2,
        ...
        "teamIcon": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqS26gF3CzSVSPFMFi2dOvlSjYpfnw5bNwVQ&usqp=CAU",
        "WonCount": 0,
    },
    {
        "id": 3,
...
let detailofTeam = [];
let detailOfPlayer = [];
var teamGrid = document.getElementById("teamlist")
...
localStorage.setItem("playerArray", JSON.stringify(playerlist));
...
let seaech = document.querySelector(".search-input");
let inputBox = seaech.querySelector("input");
let suggBox = seaech.querySelector(".autocom-box");
let icon = seaech.querySelector(".icon");
...
inputBox.onkeyup = (e)=>{
    ...
    if(userData){
        ...
        seaech.classList.remove("active");
    }
}
